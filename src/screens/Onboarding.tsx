...
const Onboarding: React.FC<OnboardingProps> = ({ navigation }) => {
    return (
        <View className="flex-1 bg-white">
            ...
            <TouchableOpacity className="bg-TEXT_GREEN py-[16px] w-[75%] rounded-full self-center mt-5" onPress={() => navigation.navigate("Signup")} style={styles.button}>
            ...
            <Text className="text-PRIMARY_GREY self-center my-8">
                Already have account? <Text onPress={() => navigation.navigate("Signin")} className="text-TEXT_GREEN font-bold">Log In</Text>
            </Text>
